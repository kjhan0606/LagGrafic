...
!--------------------
! this is redundant but necessary for a certain type of storage systems 
!  which are ill-formed (especially on the time sync)
    if (white) then
...
!   print *,'now dumping the header to ', filename
